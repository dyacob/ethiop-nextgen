# Metafont (`.mf`) Sources from the LaTeX `ethiop-t1` Package

These sources come from the CTAN `ethiop-t1` package: [https://ctan.org/pkg/ethiop-t1](https://ctan.org/pkg/ethiop-t1)
